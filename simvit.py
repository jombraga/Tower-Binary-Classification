...
class SMPLViT(nn.Module):
    def __init__(self,image_size = 72, patch_size = 6, num_classes = 1, dim = 1024, depth = 12, heads = 12,
                mlp_dim = 2048):
        super(SMPLViT, self).__init__()
        self.model = SimpleViT(image_size=image_size, patch_size=patch_size, num_classes=num_classes, dim=dim, depth=depth, 
